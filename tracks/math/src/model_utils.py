...
def build_reasoning_prompt(tokenizer, problem_prompt: str, dataset: str) -> str:
    """
    ...
    """
    instruction = (
        "Solve the following multiple-choice reasoning problem. Think through it carefully, "
        "then end with the exact format 'Final Answer: X' where X is the option label. "
